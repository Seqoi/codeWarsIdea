...
For this challenge, a is considered "close to" b if margin is greater than
        or equal to the absolute distance between a and b.
Otherwise...
...
public class CompareWithMargin {
    ...
    public static int closeCompare(double a, double b, double margin) {
        if ((margin == Math.abs((a - b))) || (margin > Math.abs((a - b)))) return 0;
        else if (margin < Math.abs(a - b) && a < b) return -1;
        else return 1;
    }
